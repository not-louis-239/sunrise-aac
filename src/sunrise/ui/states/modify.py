...
class ModifyState(State):
    def __init__(self, aac_inst: AAC) -> None:
        ...
        self.popup_rect = pg.Rect(UI_MARGIN_M, UI_MARGIN_M, WN_W - UI_MARGIN_M * 2, WN_H - UI_MARGIN_M * 2)
        ...
        self.label_input_box = InputBox(flex=6, font=self.aac_inst.assets.fonts.ui_text_font_m, inset=UI_MARGIN_M)
        self.font_size_input_box = InputBox(flex=1, font=self.aac_inst.assets.fonts.ui_text_font_m, inset=UI_MARGIN_M, sentinel_text="Auto", fixed_tooltip_width=200)
        self.node_input_box = InputBox(flex=1, font=self.aac_inst.assets.fonts.ui_text_font_m, inset=UI_MARGIN_M)
        self.dest_input_box = InputBox(flex=1, font=self.aac_inst.assets.fonts.ui_text_font_m, inset=UI_MARGIN_M)
        self.img_path_input_box = InputBox(flex=1, font=self.aac_inst.assets.fonts.ui_text_font_m, inset=UI_MARGIN_M)
        self.word_input_box = InputBox(flex=1, font=self.aac_inst.assets.fonts.ui_text_font_m, inset=UI_MARGIN_M)
        self.type_dropdown = Dropdown(flex=1, font=self.aac_inst.assets.fonts.ui_text_font_m, inset=UI_MARGIN_M, options={v: v for v in ALLOWED_BUTTON_TYPES}, sentinel="default")
        ...
        self.func_dropdown = Dropdown(flex=1, font=self.aac_inst.assets.fonts.ui_text_font_m, inset=UI_MARGIN_M, options=func_options_dict, sentinel="none")

        self.coords_label = Label(font=self.aac_inst.assets.fonts.ui_text_font_m)
        self.select_coords_button = RectangularUIButton(font=self.aac_inst.assets.fonts.ui_text_font_m, text="Select", inset=UI_MARGIN_M)
